...
<?php echo form_open_multipart('../'.url_admin().$this->module.$path, 'class="form-horizontal" id="formID"'); ?>
    ...
    <div class="col-xs-12 col-sm-8">
        ...
        <?php echo isset($form['email']) ? $form['email'] : ''; ?>
        <?php echo isset($form['username']) ? $form['username'] : ''; ?>
        <?php echo isset($form['password']) ? $form['password'] : ''; ?>
        <?php echo isset($form['passconfirm']) ? $form['passconfirm'] : ''; ?>
        <?php echo isset($form['permission']) ? $form['permission'] : ''; ?>
