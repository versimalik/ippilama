        ...
        <tbody>
            ...
            <?php foreach($data as $key => $val){ ?>
                   <tr class="rows">
                        ...
                        <td><?php echo isset($val[$this->ws_category_parent_name]) ? $val[$this->ws_category_parent_name] : ''; ?></td> 
                        <td><?php echo isset($val[$this->title_input]) ? $val[$this->title_input] : ''; ?></td> 
                        <td><center><?php echo isset($val[$this->status]) ? $this->__config_generic['active'][$val[$this->status]] : ''; ?></center></td> 
