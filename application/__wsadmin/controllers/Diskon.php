...
class Diskon extends CI_Controller {
	...
	/** field insert mysql */
	public $path_pict = '/diskon/'; //name path picture
	public $path_images = 'diskon';
	public $module = 'diskon'; //name module
	public $table = 'ws_diskon_foo'; //name table
	public $date_create = 'ws_diskon_date_create';
	public $date_update = 'ws_diskon_date_update';
	
	public $id = 'ws_diskon_id';
	public $title_input = 'ws_diskon_value';
	public $user_create = 'ws_user_create';
	public $user_update = 'ws_user_update';
	public $status = 'ws_diskon_status_publish';
	public $page = 20;
	public $count_image = 1;
	public $breadcumb = array('General', 'Diskon'); //name module
	public $id_menu = 6; 
	...
	function index($null = null, $page = null){
		...
		$this->diskon($offset, $page);
	
	}
	
	function diskon($offset, $page){
		...
		$forms['block_form'] = $this->load->view('module/diskon/block_list', $ws_result, true);
	...
	function add($data = null, $err = null){
		...
		$view = 'right/form';
		$forms['block_form'] = $this->load->view('module/diskon/block_form', $form, true);
	...
	function insert($post = null){
		...
		if(!empty($post) && $post == 'post'){
			...
			$this->form_validation->set_rules($this->title_input, 'Value', 'trim|required|integer');
